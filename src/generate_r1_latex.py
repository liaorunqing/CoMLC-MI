...
def write_temporal_table(results_dir: Path, output_dir: Path) -> None:
    ...
    lines.extend([r"\bottomrule", r"\end{tabular}", r"\end{table}"])
    (output_dir / "table_temporal_r1.tex").write_text("\n".join(lines) + "\n", encoding="utf-8")
...
def write_primary_label_table(results_dir: Path, output_dir: Path) -> None:
    ...
    lines.extend([r"\bottomrule", r"\end{tabular}", r"}", r"\end{table*}"])
    (output_dir / "table_primary_labels_r1.tex").write_text("\n".join(lines) + "\n", encoding="utf-8")
...
def write_calibration_table(results_dir: Path, output_dir: Path) -> None:
    ...
    lines.extend([r"\bottomrule", r"\end{tabular}", r"}", r"\end{table}"])
    (output_dir / "table_calibration_r1.tex").write_text("\n".join(lines) + "\n", encoding="utf-8")
...
def write_external_table(results_dir: Path, output_dir: Path) -> None:
    ...
    lines = [
        ...
        r"\label{tab:external_r1}", r"\scriptsize",
    ...
    lines.extend([r"\bottomrule", r"\end{tabular}", r"}", r"\end{table*}"])
    (output_dir / "table_external_r1.tex").write_text("\n".join(lines) + "\n", encoding="utf-8")
